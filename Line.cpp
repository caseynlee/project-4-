 ...
 * leecasey
 *
 * This represents a colored line within bounds.
 */
...
//Overloaded contructor that sets color, start to pt1, end to pt2
...
// Reads line in form startPoint, endPoint, color
void Line::read(istream& ins) {
    ins >> start >> end >> lineColor;
}

// Writes line in form startPoint, endPoint, color
