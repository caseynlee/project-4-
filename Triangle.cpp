 ...
 * leecasey
 *
 * This will represent a triangle.
 */
...
//Overloaded constructor that sets three vertices and 
// sets it all to one single color.
...
//Overloaded constructor that sets three vertices and three colors
...
//Sets color of vertex one of triangle
...
void Triangle::read(istream& ins) {
    ...
    if (ins.fail()) {
        ...
        Triangle (vertexOne, vertexOneColor, vertexTwo,
                  vertexTwoColor, vertexThree, vertexThreeColor);
    }
}


//Writes triangle in form
